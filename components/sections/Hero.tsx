  ...
  return (
    <section id="home" className="relative pt-24 sm:pt-28 pb-0 px-3 sm:px-5">
      <div className="relative rounded-[36px] sm:rounded-[40px] overflow-hidden min-h-[88svh] sm:min-h-[92svh] flex flex-col">
        ...
        <div className="absolute bottom-7 left-1/2 -translate-x-1/2 z-10 flex items-center gap-2.5 text-white/75">
          ...
          <span className="text-[10px] tracking-[0.36em] uppercase font-light">Wake Forest, NC</span>
        </div>
      </div>
    </section>
  );
